...
- [📊 **Гермес: Функціональна модель (Аналіз Г.Л. Олді)**](https://raw.githack.com/borya-mbi/hermes-proxmox-lxc/main/docs/hermes-god-oldi.html) — *преміальна інтерактивна сторінка з графіками та системним розбором ролі «Адміністратора Космосу».*
