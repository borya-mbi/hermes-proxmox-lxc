...
Для глибокого розуміння концепції проекту перегляньте аналітично-філософський нарис:
- [📊 **Аналіз функціональної моделі Бога Гермеса (Г.Л. Олді)**](https://raw.githack.com/borya-mbi/hermes-proxmox-lxc/main/docs/hermes-god-oldi.html) - опис ролі Гермеса як системного оператора Олімпу. Графіки компетенцій та методи впливу на сюжет.
